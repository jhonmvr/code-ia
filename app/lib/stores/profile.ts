...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('codeia_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('codeia_profile', JSON.stringify(profileStore.get()));
  }
};
