  ...
  <example>
    ...
    <assistant_response>
      ...
      <codeiaArtifact id="factorial-function" title="JavaScript Factorial Function">
        <codeiaAction type="file" filePath="index.js">
  ...
  <example>
    ...
    <assistant_response>
      ...
      <codeiaArtifact id="snake-game" title="Snake Game in HTML and JavaScript">
        ...
        <codeiaAction type="file" filePath="index.html">
          ...
        </codeiaAction>
  ...
  <example>
    ...
    <assistant_response>
      ...
      <codeiaArtifact id="bouncing-ball-react" title="Bouncing Ball with Gravity in React">
        ...
        <codeiaAction type="file" filePath="src/main.jsx">
          ...
        </codeiaAction>

        <codeiaAction type="file" filePath="src/index.css">
          ...
        </codeiaAction>

        <codeiaAction type="file" filePath="src/App.jsx">
          ...
        </codeiaAction>
