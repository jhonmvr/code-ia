    ...
    <motion.div
      ...
      className={classNames(
        ...
        active
          ...
          : 'bg-codeia-elements-background-depth-2 dark:bg-codeia-elements-background-depth-3 text-codeia-elements-textSecondary dark:text-codeia-elements-textSecondary-dark border border-codeia-elements-borderColor dark:border-codeia-elements-borderColor-dark',
        onRemove && 'pr-1',
        className,
      )}
    >
          ...
          <span
            className={
              active
                ...
                : 'text-codeia-elements-textPrimary dark:text-codeia-elements-textPrimary-dark'
            }
          >
            {value}
          </span>
      ...
      {onRemove && (
        <button
          ...
          onClick={onRemove}
          className={classNames(
            'ml-1 p-0.5 rounded-full hover:bg-codeia-elements-background-depth-3 dark:hover:bg-codeia-elements-background-depth-4 transition-colors',
            active
