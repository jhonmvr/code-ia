      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-codeia-elements-textPrimary dark:text-codeia-elements-textPrimary-dark'
              : 'text-codeia-elements-textSecondary dark:text-codeia-elements-textSecondary-dark hover:text-codeia-elements-textPrimary dark:hover:text-codeia-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-codeia-elements-textTertiary dark:text-codeia-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
