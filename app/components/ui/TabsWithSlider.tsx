        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-codeia-elements-background-depth-2 dark:bg-codeia-elements-background-depth-3 text-codeia-elements-textPrimary dark:text-codeia-elements-textPrimary-dark hover:bg-codeia-elements-background-depth-3 dark:hover:bg-codeia-elements-background-depth-4 border border-codeia-elements-borderColor dark:border-codeia-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
