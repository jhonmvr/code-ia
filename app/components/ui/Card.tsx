  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-codeia-elements-borderColor bg-codeia-elements-background-depth-1 text-codeia-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-codeia-elements-textSecondary', className)} {...props} />;
  },
);
