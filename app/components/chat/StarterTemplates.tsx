...
const StarterTemplates = memo(() => {
  ...
  return (
    <div className="max-w-chat mx-auto px-4 lg:px-0">
      <h3 className="text-lg font-semibold text-codeia-elements-textPrimary mb-4">
        Starter Templates
      </h3>
        ...
        {templates.map((template, index) => (
          <div
            ...
            className={classNames(
              'p-4 bg-codeia-elements-background-depth-1',
              'border border-codeia-elements-borderColor rounded-lg',
              'hover:bg-codeia-elements-background-depth-2 transition-colors cursor-pointer'
            )}
          >
