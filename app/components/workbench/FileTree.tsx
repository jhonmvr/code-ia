...
function ContextMenuItem({ onSelect, children }: { onSelect?: () => void; children: ReactNode }) {
  return (
    <ContextMenu.Item
      onSelect={onSelect}
      className="flex items-center gap-2 px-2 py-1.5 outline-0 text-sm text-codeia-elements-textPrimary cursor-pointer ws-nowrap text-codeia-elements-item-contentDefault hover:text-codeia-elements-item-contentActive hover:bg-codeia-elements-item-backgroundActive rounded-md"
    >
...
function InlineInput({ depth, placeholder, initialValue = '', onSubmit, onCancel }: InlineInputProps) {
  ...
  return (
    <div
      className="flex items-center w-full px-2 bg-codeia-elements-background-depth-4 border border-codeia-elements-item-contentAccent py-0.5 text-codeia-elements-textPrimary"
      style={{ paddingLeft: `${6 + depth * NODE_PADDING_LEFT}px` }}
    >
      <div className="scale-120 shrink-0 i-ph:file-plus text-codeia-elements-textTertiary" />
      <input
        ref={inputRef}
        type="text"
        className="ml-2 flex-1 bg-transparent border-none outline-none py-0.5 text-sm text-codeia-elements-textPrimary placeholder:text-codeia-elements-textTertiary min-w-0"
    ...
    <>
      <ContextMenu.Root>
        <ContextMenu.Trigger>
          <div
            ...
            className={classNames('relative', {
              'bg-codeia-elements-background-depth-2 border border-dashed border-codeia-elements-item-contentAccent rounded-md':
                isDragging,
            })}
          >
            {children}
        ...
        <ContextMenu.Portal>
          <ContextMenu.Content
            style={{ zIndex: 998 }}
            className="border border-codeia-elements-borderColor rounded-md z-context-menu bg-codeia-elements-background-depth-1 dark:bg-codeia-elements-background-depth-2 data-[state=open]:animate-in animate-duration-100 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-98 w-56"
          >
            <ContextMenu.Group className="p-1 border-b-px border-solid border-codeia-elements-borderColor">
            ...
            <ContextMenu.Group className="p-1 border-t-px border-solid border-codeia-elements-borderColor">
              {!isFolder ? (
                <>
    ...
    <FileContextMenu onCopyPath={onCopyPath} onCopyRelativePath={onCopyRelativePath} fullPath={folder.fullPath}>
      <NodeButton
        className={classNames('group', {
          'bg-transparent text-codeia-elements-item-contentDefault hover:text-codeia-elements-item-contentActive hover:bg-codeia-elements-item-backgroundActive':
            !selected,
          'bg-codeia-elements-item-backgroundAccent text-codeia-elements-item-contentAccent': selected,
        })}
        depth={folder.depth}
...
function File({
  ...
  return (
    <FileContextMenu onCopyPath={onCopyPath} onCopyRelativePath={onCopyRelativePath} fullPath={fullPath}>
      <NodeButton
        className={classNames('group', {
          'bg-transparent hover:bg-codeia-elements-item-backgroundActive text-codeia-elements-item-contentDefault':
            !selected,
          'bg-codeia-elements-item-backgroundAccent text-codeia-elements-item-contentAccent': selected,
        })}
        depth={depth}
        iconClasses={classNames('i-ph:file-duotone scale-98', {
          'group-hover:text-codeia-elements-item-contentActive': !selected,
        })}
        onClick={onClick}
      >
        <div
